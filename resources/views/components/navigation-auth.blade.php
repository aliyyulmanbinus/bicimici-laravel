<nav id="nav-auth" class="flex w-full bg-white border-b border-bicimici-grey">
            <div class="flex w-[1280px] px-[75px] py-5 items-center justify-between mx-auto">
                <div class="flex items-center gap-[30px]">
                    <a href="{{ route ('front.index') }}" class="flex shrink-0">
                        <img src="{{ asset('assets/images/logos/') }}" class="flex shrink-0" alt="logo">
                    </a>
                    <form action="search-course.html" class="relative ">
                        <label class="group">
                            <input type="text" name="" id="" class="appearance-none outline-none ring-1 ring-bicimici-grey rounded-full w-[400px]  py-[14px] px-5 bg-white font-bold placeholder:font-normal placeholder:text-bicimici-text-secondary group-focus-within:ring-bicimici-green transition-all duration-300 pr-[50px]" placeholder="Search course by name">
                ...
                <div class="flex items-center gap-5 justify-end">
                    ...
                    <div id="profile-dropdown" class="relative flex items-center gap-[14px]">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-bicimici-text-secondary">{{ $user->occupation }}</p>
                        </div>
                        ...
                        <div id="dropdown" class="absolute top-full right-0 mt-[7px] w-[170px] h-fit bg-white rounded-xl border border-bicimici-grey py-4 px-5 shadow-[0px_10px_30px_0px_#B8B8B840] z-10 hidden">
                            <ul class="flex flex-col gap-[14px]">
                                <li class="hover:text-bicimici-green transition-all duration-300">
