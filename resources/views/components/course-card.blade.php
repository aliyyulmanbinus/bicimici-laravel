                            ...
                            <div class="course-card flex flex-col rounded-[20px] border border-bicimici-grey hover:border-bicimici-green transition-all duration-300 bg-white overflow-hidden">
                                ...
                                <div class="flex flex-col p-4 pt-0 gap-[13px]">
                                    ...
                                    <p class="flex items-center gap-[6px]">
                                        ...
                                        <span class="text-sm text-bicimici-text-secondary">{{ $course->category->name }}</span>
                                    </p>
                                    <p class="flex items-center gap-[6px]">
                                        <img src="{{ asset ('assets/images/icons/menu-board-green.svg') }}" class="flex shrink-0 w-5" alt="icon">
                                        <span class="text-sm text-bicimici-text-secondary">{{ $course->content_count }} Lessons</span>
                                    </p>
                                    <p class="flex items-center gap-[6px]">
                                        <img src="{{ asset ('assets/images/icons/briefcase-green.svg') }}" class="flex shrink-0 w-5" alt="icon">
                                        <span class="text-sm text-bicimici-text-secondary">Ready to Work</span>
                                    </p>
                                </div>
                            </div>
                        </a>