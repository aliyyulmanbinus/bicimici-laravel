<nav id="nav-guest" class="flex w-full bg-white border-b border-bicimici-grey">
            <div class="flex w-[1280px] px-[75px] py-5 items-center justify-between mx-auto">
                ...
                <div class="flex items-center gap-5 justify-end">
                    ...
                    <div class="flex items-center gap-3">
                        <a href="{{ route('register') }}" class="rounded-full border border-bicimici-grey py-3 px-5 gap-[10px] bg-white hover:border-bicimici-green transition-all duration-300">
                            <span class="font-semibold">Sign Up</span>
                        </a>
                        <a href={{ route('login') }} class="rounded-full py-3 px-5 gap-[10px] bg-bicimici-green hover:drop-shadow-effect transition-all duration-300">
