...
@section('title', 'Subscription Details - bicimici LMS')
@section('content')
    <x-navigation-auth />
        ...
        <div class="flex w-[1000px] !h-fit rounded-[20px] border border-bicimici-grey gap-[40px] bg-white items-center p-5">
                    ...
                    <div class="flex items-center justify-between rounded-[20px] border border-bicimici-grey p-[14px]">
                        <div class="profile flex items-center gap-[14px]">
                            ...
                            <div class="desc flex flex-col gap-[3px]">
                                <h3 class="text-sm leading-[21px] text-bicimici-text-secondary">Booking TRX ID</h3>
                ...
                <section id="transaction-details" class="flex flex-col gap-[12px]">
                    ...
                    <div class="flex flex-col gap-[12px]">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <strong class="font-bold text-bicimici-green text-[22px] leading-[33px]">
                ...
                <section id="access given-to" class="flex flex-col gap-2">
                    ...
                    <div class="profile flex items-center gap-[14px] rounded-[20px] border border-bicimici-grey p-[14px]">
                        ...
                        <div class="desc flex flex-col gap-[3px]">
                            ...
                            <p class="text-sm leading-[21px] text-bicimici-text-secondary">
            ...
            <div id="benefits" class="bg-[#F8FAF9] rounded-[20px] overflow-hidden shrink-0 w-[420px]">
                ...
                <section id="points" class="pt-[61px] relative flex flex-col gap-4 px-5 pb-5">
                    <div class="card absolute -top-[47px] left-[30px] right-[30px] flex items-center p-4 gap-[14px] border border-bicimici-grey rounded-[20px] bg-white shadow-[0px_10px_30px_0px_#B8B8B840]">
                        ...
                        <div>
                            ...
                            <p class="text-bicimici-text-secondary">3 months duration</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-2">
