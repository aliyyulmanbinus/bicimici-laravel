...
@section('title', 'Success Checkout - bicimici LMS')
@section('content')
    <x-navigation-auth />
    ...
    <main class="flex justify-center py-5 flex-1 items-center">
        <div class="w-[500px] flex flex-col gap-[30px]">
            <div class="flex flex-col gap-[10px]">
                <div class="rounded-full !w-fit mx-auto py-2 px-[14px] bg-bicimici-light-green flex items-center gap-[6px]">
                ...
                <p class="text-center leading-[28px] text-bicimici-text-secondary">Anda telah memiliki akses kelas materi
                    terbaru sebagai persiapan bekerja di era digital industri saat ini, yay!</p>
            </div>
            <section id="card"
                class="relative rounded-[20px] border border-bicimici-grey p-[10px] flex items-center gap-4 bg-white">
                ...
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex items-center gap-[6px]">
                        ...
                        <p class="text-bicimici-text-secondary text-sm leading-[21px]">{{ $pricing->duration }} Months Access</p>
                    </div>
                    <div class="flex items-center gap-[6px]">
                        <img src="{{ asset('assets/images/icons/briefcase-green.svg') }}" alt="icon" class="size-[20px] shrink-0" />
                        <p class="text-bicimici-text-secondary text-sm leading-[21px]">Job-Ready Skills</p>
                    </div>
                </div>
            ...
            <div class="flex items-center gap-[14px] mx-auto">
                <a href="{{ route('dashboard.subscriptions') }}">
                    <div
                        class="flex items-center px-5 justify-center border border-bicimici-grey rounded-full py-[10px] bg-white hover:border-bicimici-green transition-all duration-300">
                        <p class="font-semibold">My Transactions</p>
                    </div>
                </a>
                <a href="{{ route('dashboard') }}">
                    <div
                        class="flex items-center px-5 justify-center text-white rounded-full py-[10px] bg-bicimici-green hover:drop-shadow-effect transition-all duration-300">
