...
@section('title', 'Checkout - bicimici')
@section('content')
    <x-navigation-auth />
    <div id="path" class="flex w-full bg-white border-b border-bicimici-grey py-[14px]">
        <div class="flex items-center w-full max-w-[1280px] px-[75px] mx-auto gap-5">
            <a href="{{ route('front.index') }}home" class="last-of-type:font-semibold">Home</a>
            <div class="h-10 w-px bg-bicimici-grey"></div>
            <a href="{{ route('front.pricing') }}" class="last-of-type:font-semibold">Pricing Packages</a>
            <span class="text-bicimici-grey">/</span>
            <a href="#" class="last-of-type:font-semibold">Checkout Subscription</a>
        </div>
    </div>
    <main class="flex flex-1 justify-center py-5 items-center">
        <div class="flex w-[1000px] !h-fit rounded-[20px] border border-bicimici-grey gap-[40px] bg-white items-center p-5">
            <form id="checkout-details" method="POST" class="w-full flex flex-col gap-5">
                    ...
                    <div class="flex items-center justify-between rounded-[20px] border border-bicimici-grey p-[14px]">
                        <div class="profile flex items-center gap-[14px]">
                            ...
                            <div class="desc flex flex-col gap-[3px]">
                                ...
                                <p class="text-sm leading-[21px] text-bicimici-text-secondary">{{ $user->occupation }}</p>
                            </div>
                        </div>
                        <a href="#">
                            <p class="text-sm leading-[21px] hover:underline text-bicimici-green">Change Account</p>
                        </a>
                    </div>
                </section>
                <section id="transaction-details" class="flex flex-col gap-[12px]">
                    ...
                    <div class="flex flex-col gap-[12px]">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <strong class="font-bold text-[22px] leading-[33px] text-bicimici-green">Rp
                ...
                <div class="grid grid-cols-2 gap-[14px]">
                    <a href="{{ route('front.pricing') }}">
                        <div
                            class="flex border border-bicimici-grey rounded-full items-center justify-center py-[10px] hover:border-bicimici-green transition-all duration-300">
                            <p class="font-semibold">Cancel</p>
                        </div>
                    </a>
                    <button id="pay-button" type="button"
                        class="flex text-white bg-bicimici-green rounded-full items-center justify-center py-[10px] hover:drop-shadow-effect transition-all duration-300">
                        <p class="font-semibold">Pay Now</p>
                    </button>
                </div>
                <hr class="border-bicimici-grey" />
                <p class="text-sm leading-[21px] text-center hover:underline text-bicimici-text-secondary">Pahami Terms &
            ...
            <div id="benefits" class="bg-[#F8FAF9] rounded-[20px] overflow-hidden shrink-0 w-[420px]">
                ...
                <section id="points" class="pt-[61px] relative flex flex-col gap-4 px-5 pb-5">
                    <div
                        class="card absolute -top-[47px] left-[30px] right-[30px] flex items-center p-4 gap-[14px] border border-bicimici-grey rounded-[20px] bg-white shadow-[0px_10px_30px_0px_#B8B8B840]">
                        ...
                        <div>
                            ...
                            <p class="text-bicimici-text-secondary">{{ $pricing->duration }} months duration</p>
                        </div>
                    </div>
                    <div class="flex items-center gap-2">
