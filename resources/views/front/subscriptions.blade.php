...
@section('title', 'My Subscriptions - bicimici LMS')
@section('content')
    <x-navigation-auth />
    <nav id="bottom-nav" class="flex w-full bg-white border-b border-bicimici-grey py-[14px]">
        <ul class="flex w-full max-w-[1280px] px-[75px] mx-auto gap-3">
            <li class="group">
                <a href="#" class="flex items-center gap-2 rounded-full border border-bicimici-grey py-2 px-[14px] hover:border-bicimici-green bg-white transition-all duration-300 group-[.active]:bg-bicimici-light-green group-[.active]:border-bicimici-light-green">
                    <img src="{{ asset ('assets/images/icons/home-trend-up.svg') }}" class="flex shrink-0 w-5" alt="icon">
                    <span>Overview</span>
                </a>
            </li>
            <li class="group">
                <a href="{{ route('dashboard') }}" class="flex items-center gap-2 rounded-full border border-bicimici-grey py-2 px-[14px] hover:border-bicimici-green bg-white transition-all duration-300 group-[.active]:bg-bicimici-light-green group-[.active]:border-bicimici-light-green">
    ...
    <main class="relative flex flex-1 h-full">
        ...
        <section id="subscriptions-list" class="relative flex flex-col gap-5 mt-[50px] w-full max-w-[1280px] px-[75px] py-5 mx-auto">
            ...
            <div id="list-container" class="flex flex-col gap-5 max-w-[800px] w-full">
                ...
                <div class="subscription-card bg-white border border-bicimici-grey flex items-center justify-between rounded-[20px] py-5 px-4 gap-8">
                    <div class="flex items-center flex-1 gap-[14px]">
                        ...
                        <div>
                            ...
                            <p class="text-bicimici-text-secondary">{{ $transaction->pricing->duration }} months duration</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-center w-[75px] shrink-0">
                        <span class="font-bold text-xs text-bicimici-green badge w-fit rounded-full py-[6px] px-[10px] gap-[6px] bg-bicimici-light-green">ACTIVE</span>
                    </div>
                    @else
                    <div class="flex items-center justify-center w-[75px] shrink-0">
                        <span class="font-bold text-xs text-bicimici-red badge w-fit rounded-full py-[6px] px-[10px] gap-[6px] bg-bicimici-light-red">EXPIRED</span>
                    </div>
                    @endif
                    <a href="{{ route('dashboard.subscription.details', $transaction) }}" class="rounded-full border border-bicimici-grey py-[10px] px-5 gap-[10px] bg-white hover:border-bicimici-green transition-all duration-300">
