...
@section('title', 'Success Joined - bicimici LMS')
@section('content')
<div class="relative flex justify-center">
    ...
    <main class="relative mt-[178px] flex flex-col gap-[30px] p-[30px] w-[560px] rounded-[20px] border bg-white border-bicimici-grey">
        ...
        <div class="mx-auto flex w-[500px] flex-col gap-[10px] items-center">
            ...
            <p class="text-center text-bicimici-text-secondary leading-[28px]">Mari kita belajar meningkatkan skills terbaru bersama dengan mentor berpengalaman demi masa depan lebih baik</p>
        </div>
        ...
        <div class="buttons grid grid-cols-2 gap-[12px]">
            ...
            class="text-white rounded-full py-[10px] flex justify-center items-center bg-bicimici-green hover:drop-shadow-effect transition-all duration-300">
