...
@section('title', 'Details - bicimici LMS')
@section('content')
    <x-navigation-auth />
    <nav id="bottom-nav" class="flex w-full bg-white border-b border-bicimici-grey py-[14px]">
        <ul class="flex w-full max-w-[1280px] px-[75px] mx-auto gap-3">
            <li class="group">
                <a href="#"
                    class="flex items-center gap-2 rounded-full border border-bicimici-grey py-2 px-[14px] hover:border-bicimici-green bg-white transition-all duration-300 group-[.active]:bg-bicimici-light-green group-[.active]:border-bicimici-light-green">
            ...
            <div id="course-info" class="flex flex-col justify-center gap-[30px]">
                ...
                <div class="flex items-center gap-3">
                    <a href="{{ route('dashboard.course.join', $course->slug) }}"
                        class="rounded-full py-[10px] px-5 gap-[10px] bg-bicimici-green hover:drop-shadow-effect transition-all duration-300">
                        <span class="font-semibold text-white">Start Learning Now</span>
                    </a>
                    <a href="#"
                        class="rounded-full border border-bicimici-grey py-[10px] px-5 gap-[10px] bg-white hover:border-bicimici-green transition-all duration-300">
            ...
            <div id="contents" class="flex flex-col gap-5">
                <div id="tabs-container" class="flex items-center gap-3">
                    <button type="button" class="tab-btn group active" data-target="about-content">
                        <p
                            class="rounded-full border border-bicimici-grey py-2 px-4 hover:border-bicimici-green bg-white transition-all duration-300 group-[.active]:bg-bicimici-black">
                ...
                <div id="tabs-content-container">
                    <div id="about-content" class="tab-content flex flex-col gap-[30px]">
                        ...
                        <div id="instructors"
                            class="flex flex-col w-full max-w-[900px] rounded-[20px] border border-bicimici-grey p-5 gap-4 bg-white">
                            <h3 class="font-semibold text-lg">Course Instructors</h3>
                            <div class="grid grid-cols-2 gap-5">

                                @foreach($course->courseMentors as $mentor)
                                <div
                                    class="instructors-card flex flex-col rounded-[20px] border border-bicimici-grey p-5 gap-4 bg-white">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-bicimici-text-secondary">
                    ...
                    <div id="lessons-content" class="tab-content flex flex-col gap-5 w-full max-w-[650px] hidden">
                        ...
                        <div class="accordion flex flex-col gap-4 rounded-[20px] border border-bicimici-grey p-5 bg-white">
                            ...
                            <div id="{{ $section->id }}" class="">
                                <div class="flex flex-col gap-4">
                                    ...
                                    <div
                                        class="flex items-center rounded-[50px] gap-[10px] border border-bicimici-grey py-3 px-4 bg-white">
                    ...
                    <div id="testimonials-content" class="tab-content grid grid-cols-2 w-full max-w-[860px] gap-5 hidden">
                        <div
                            class="testimonial-card flex flex-col rounded-[20px] border border-bicimici-grey p-5 gap-4 bg-white">
                            <div class="flex items-center">
