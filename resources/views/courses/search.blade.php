...
@section('title', 'Search Courses - bicimici LMS')
@section('content')
    <x-navigation-auth />
    ...
    <main class="flex flex-col gap-10 pb-10 mt-[50px]">
        <div class="flex flex-col items-center gap-[10px] max-w-[500px] w-full mx-auto">
            ...
            <form method="GET" action="{{ route('dashboard.search.courses') }}" class="relative ">
                <label class="group">
                    <input type="text" name="search" id="" class="appearance-none outline-none ring-1 ring-bicimici-grey rounded-full w-[550px] py-[14px] px-5 bg-white font-bold placeholder:font-normal placeholder:text-bicimici-text-secondary group-focus-within:ring-bicimici-green transition-all duration-300 pr-[50px]" placeholder="Search course by name">
