...
@section('title', 'My Courses - bicimici')
@section('content')
    <x-navigation-auth />
    ...
    <main class="flex flex-col gap-10 pb-10 mt-[30px]">
        <section id="roadmap" class="flex flex-col w-full max-w-[1280px] px-[75px] gap-4 mx-auto">
            ...
            <div class="grid grid-cols-2 gap-5">
                <a href="#" class="card">
                    <div
                        class="roadmap-card flex items-center rounded-[20px] border border-bicimici-grey p-[10px] pr-4 gap-4 bg-white hover:border-bicimici-green transition-all duration-300">
                        <div
                            class="relative flex shrink-0 w-[240px] h-[150px] rounded-[14px] overflow-hidden bg-bicimici-grey">
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <p class="flex items-center gap-[6px]">
                                ...
                                <span class="text-sm text-bicimici-text-secondary">Rp 125.500.000/year</span>
                            </p>
                            <p class="flex items-center gap-[6px]">
                                <img src="{{ asset('assets/images/icons/menu-board-green.svg') }}" class="flex shrink-0 w-5"
                                    alt="icon">
                                <span class="text-sm text-bicimici-text-secondary">18,498 Courses</span>
                            </p>
                        </div>
                    </div>
                </a>
        ...
        <section id="catalog" class="flex flex-col w-full max-w-[1280px] px-[75px] gap-4 mx-auto">
            ...
            <div id="tabs-container" class="flex items-center gap-3">
                ...
                <button type="button" class="tab-btn group {{ $loop->first ? 'active' : '' }}"
                    ...
                    <p class="rounded-full border border-bicimici-grey py-2 px-4 hover:border-bicimici-green bg-white transition-all duration-300 group-[.active]:bg-bicimici-black">
