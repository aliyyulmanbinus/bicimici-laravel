...
@section('title', 'Course Finished - bicimici LMS')
@section('content')
<div class="relative flex justify-center">
    ...
    <main class="relative mt-[178px] flex flex-col gap-[30px] p-[30px] w-[560px] rounded-[20px] border bg-white border-bicimici-grey">
        ...
        <div class="mx-auto flex w-[500px] flex-col gap-[10px] items-center">
            ...
            <p class="text-center text-bicimici-text-secondary leading-[28px]">Anda telah menyelesaikan materi kelas dengan baik selanjutnya dapat membuat portfolio dan mengikuti magang</p>
        </div>
        <div id="card" class="flex items-center pt-[10px] pb-[10px] pl-[10px] pr-4 border border-bicimici-grey rounded-[20px] gap-4">
            ...
            <div class="flex flex-col gap-[10px]">
                ...
                <div class="flex items-center gap-[6px]">
                    ...
                    <p class="text-sm leading-[21px] text-bicimici-text-secondary">{{ $course->category->name }}</p>
                </div>
                <div class="flex items-center gap-[6px]">
                    <img src="{{ asset('assets/images/icons/menu-board-green.svg') }}" alt="icon" class="size-5 shrink-0" />
                    <p class="text-sm leading-[21px] text-bicimici-text-secondary">{{ $course->content_count }} Lessons</p>
                </div>
            </div>
        </div>
        <div class="buttons grid grid-cols-2 gap-[12px]">
            <a href="#" class="border border-bicimici-grey rounded-full py-[10px] flex justify-center items-center hover:border-bicimici-green transition-all duration-300">
                <span class="font-semibold">Get My Certificate</span>
            </a>
            <a href="{{ route('dashboard') }}" class="text-white rounded-full py-[10px] flex justify-center items-center bg-bicimici-green hover:drop-shadow-effect transition-all duration-300">
